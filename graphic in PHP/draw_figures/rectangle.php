...
<h2>Prostokąt</h2>
    ...
    $green = $_GET["green"];
    $blue = $_GET["blue"];
    echo "<form method='post' action='draw/rectangle.php?red=$red&green=$green&blue=$blue'>";
    ?>

    <h>Ustaw przeciwległe punkty</h><br><br>
    <label for="start">Pierwszy</label><br>
